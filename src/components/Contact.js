...
const Contact = () => {
  ...
  const socialLinks = [
    ...
    {
      name: 'LinkedIn',
      href: 'https://linkedin.com/in/aaryasingh',
      icon: (
            ...
            <div className="card">
              ...
              <div className="space-y-4">
                {socialLinks.map((link, index) => (
                  ...
                  >
                    <div className="w-10 h-10 bg-white rounded-full flex items-center justify-center mr-4 group-hover:bg-primary-100 transition-colors duration-200">
                      <div className="text-gray-600 group-hover:text-primary-600 transition-colors duration-200">
                        {link.icon}
                      </div>
                    </div>
                    <div>
